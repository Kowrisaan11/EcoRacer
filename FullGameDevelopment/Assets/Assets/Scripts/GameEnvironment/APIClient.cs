...
public class APIClient : MonoBehaviour
{
    ...
    private float previousConsumption = 0f;
    private static float difference = 0f;
    private float currentConsumption = 0f;
    ...
    IEnumerator FetchData(string token)
    {
        ...
        while (true)
        {
            ...
            else
            {
                ...
                Debug.Log($"Previous Consumption: {previousConsumption}");
                Debug.Log($"Current Consumption: {currentConsumption}");
                if (previousConsumption != 0f)
                {
                    difference = currentConsumption - previousConsumption;
                }
    ...
    public float GetPowerDifference()
    {
        return difference;
    }
}
...
{
    // Assuming some functionality here for ScoreManager
}
